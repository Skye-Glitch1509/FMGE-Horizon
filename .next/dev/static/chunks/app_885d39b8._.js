...
function PlannerDashboard() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "PlannerDashboard.useEffect": ()=>{
            ...
            const handleBeforeInstallPrompt = {
                "PlannerDashboard.useEffect.handleBeforeInstallPrompt": (e)=>{
                    e.preventDefault();
                    setInstallPrompt(e);
                }
            }["PlannerDashboard.useEffect.handleBeforeInstallPrompt"];
            window.addEventListener("beforeinstallprompt", handleBeforeInstallPrompt);
            return ({
                "PlannerDashboard.useEffect": ()=>window.removeEventListener("beforeinstallprompt", handleBeforeInstallPrompt)
            })["PlannerDashboard.useEffect"];
        }
    }["PlannerDashboard.useEffect"], []);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "PlannerDashboard.useEffect": ()=>{
            const checkUser = {
                "PlannerDashboard.useEffect.checkUser": async ()=>{
                    try {
            ...
            }["PlannerDashboard.useEffect.checkUser"];
            const timer = setTimeout({
                "PlannerDashboard.useEffect.timer": ()=>checkUser()
            }["PlannerDashboard.useEffect.timer"], 500);
            return ({
                "PlannerDashboard.useEffect": ()=>clearTimeout(timer)
            })["PlannerDashboard.useEffect"];
        }
    }["PlannerDashboard.useEffect"], []);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "PlannerDashboard.useEffect": ()=>{
            const interval = setInterval({
                "PlannerDashboard.useEffect.interval": ()=>{
            ...
            }["PlannerDashboard.useEffect.interval"], 60000);
            return ({
    ...
    async function handleSyncLoad() {
        ...
        try {
            const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("planner_data").select("*").eq("user_id", user.id).single();
            if (error) {
...
_s(PlannerDashboard, "csYPQScYDdh0hUHsCmGky2AAPCA=");
_c = PlannerDashboard;
var _c;
...
//# sourceMappingURL=app_885d39b8._.js.map