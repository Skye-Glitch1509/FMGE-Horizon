      ...
      <div style={{ maxWidth: '1280px', margin: '0 auto', padding: '48px 16px 40px' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '16px', marginBottom: '12px' }}>
          ...
          <div>
            ...
            <p style={{ color: '#9ca3af', marginTop: '4px', fontSize: '14px' }}>Master all 19 subjects • Track every topic • Only Topics from Past 10 Years Papers are included in this syllabus • '*' Indicates repeated questions in different years •</p>
          </div>
        </div>
