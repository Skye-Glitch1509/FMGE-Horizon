...
export default function Home() {
  ...
  function handleReminderConfigChange(key: keyof ReminderConfig, value: any) {
    const newConfig = { ...reminderConfig, [key]: value };
      ...
      subjects.map((subj, idx) =>
        idx === i
          ? {
              ...
              mcqSessions: [...subj.mcqSessions, { date: todayISO(), amount: val }],
            }
          : subj
      )
    );
  ...
  function handleEditStart(i: number) {
    setEditIndex(i);
    setEditFields({ ...subjects[i] });
  }

  function handleEditChange(field: keyof Subject, value: any) {
    setEditFields({ ...editFields, [field]: value });
  }

  function handleEditSave(i: number) {
    setSubjects(
      subjects.map((subj, idx) => (idx === i ? { ...subj, ...editFields } : subj))
    );
    setEditIndex(null);
  }
  ...
  function handleWellnessChange(val: number) {
    setWellness((arr) => [...arr.slice(1), val]);
  }
  ...
  return (
    ...
    >
      ...
      >
        <div style={{ color: "#c4d7fd", fontWeight: "bold" }}>FMGE Planner</div>
        <button
      ...
      <div className={`nav-hidden ${mobileMenuOpen ? "show" : ""}`} style={{ width: "100%" }}>
        <button
          onClick={() => {
            setShowCharts(false);
      ...
      >
        ...
        {canInstall && (
          ...
          >
            <div style={{ color: "#c4d7fd", fontWeight: "bold", marginBottom: "10px" }}>
              📱 Install FMGE Planner as App
            </div>
            <button
        ...
        {notificationPermission === "granted" && (
          <div style={{ marginBottom: "20px", padding: "15px", background: "#18192b", borderRadius: "12px" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
              <label style={{ color: "#b8cdf1", display: "flex", alignItems: "center", gap: "8px" }}>
                <input
                  type="checkbox"
                  checked={reminderConfig.enabled}
                  onChange={(e) => handleReminderConfigChange("enabled", e.target.checked)}
                  style={{ accentColor: "#2352a1", width: "18px", height: "18px" }}
                />
              ...
              {reminderConfig.enabled && (
                <>
                  <div>
                    <label style={{ color: "#b8cdf1", fontSize: "0.9rem", display: "block", marginBottom: "4px" }}>
                      Reminder Time:
                    </label>
                    <input
                      type="time"
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onChange={(e) =>
                        handleReminderConfigChange("reminderDay", e.target.value as "same-day" | "day-before")
                      }
                      style={{
                        background: "#151624",
                        color: "#efeff5",
        ...
        <div style={{ marginBottom: "20px", padding: "15px", background: "#18192b", borderRadius: "12px" }}>
          {!isLoggedIn ? (
            ...
            <div>
              <div style={{ color: "#c4d7fd", fontWeight: "bold" }}>
                ✅ Logged in as: <span style={{ color: "#43ea8f" }}>{user?.email}</span>
              </div>
              <div
                style={{
        ...
        {!showCharts ? (
          <>
            ...
            <div style={{ color: "#43ea8f", fontWeight: "bold", fontSize: "1.08rem", marginBottom: "12px" }}>
              🎯 <span>Goal:</span>{" "}
              <span style={{ color: "#eaeefa", fontWeight: "normal" }}>{goal}</span>
            </div>
            <input
              style={{
                width: "99.5%",
            ...
            <div style={{ marginBottom: "15px" }}>
              <label style={{ color: "#c4d7fd", fontWeight: "bold", fontSize: "1rem", marginBottom: "4px", display: "block" }}>
                📊 Weekly MCQ Goal: {mcqGoal}
              </label>
              <input
                type="range"
                min="50"
            ...
            <div style={{ display: "flex", gap: "19px", marginBottom: "18px", flexWrap: "wrap" }}>
              <div style={{ flex: 1, minWidth: "200px", background: "#18192b", padding: "13px", borderRadius: "13px" }}>
                ...
                <div style={{ fontSize: "0.96rem", marginTop: "5px" }}>
              ...
              <div style={{ flex: 1, minWidth: "200px", background: "#18192b", padding: "13px", borderRadius: "13px" }}>
                ...
                <div style={{ fontSize: "0.96rem", marginTop: "5px" }}>
                  {doneMCQ} / {totalMCQ} MCQs done
                </div>
              </div>
            </div>

            <div style={{ display: "flex", alignItems: "center", marginBottom: "13px", gap: "18px", flexWrap: "wrap" }}>
              <div
                style={{
                  background: "#18192b",
                  borderRadius: "10px",
            ...
            >
              ...
              <div>
                ...
                >
                  High Priority <span style={{ color: "#f5c500", fontSize: "1.12rem" }}>⭐</span>
                </label>
                <div style={{ display: "flex", alignItems: "center", gap: 10, minHeight: "44px" }}>
                  <input
                    type="checkbox"
                    checked={newPriority}
                ...
                >
                  {editIndex === i ? (
                    ...
                    <>
                      ...
                      <div style={{ marginBottom: "3px" }}>
                        ...
                        {deadlineStatus(subj.deadline) && (
                          <span
                            style={{
                              color:
                                deadlineStatus(subj.deadline) === "Due soon"
                                  ? "#ffba1a"
                                  : deadlineStatus(subj.deadline) === "Due today"
                                  ? "#43ea8f"
                                  : "#fe3292",
                              marginLeft: "12px",
                            }}
                      ...
                      <div style={{ marginBottom: "3px" }}>
                        <span style={{ color: "#b8cdf1", fontWeight: "bold", marginRight: "6px" }}>
                          Notes/Resource:
                        </span>
                      ...
                      <div style={{ marginBottom: "3px" }}>
                        ...
                        <span style={{ color: "#ffd36d" }}>
                          ...
                          {subj.resourceRating > 0 && (
                            <span style={{ color: "#ffba1a" }}> ({subj.resourceRating}★)</span>
                          )}
                        </span>
                      </div>
                      ...
                      <div style={{ marginBottom: "4px" }}>
                        ...
                        />
                        <span style={{ color: "#43ea8f" }}>
                          {subj.completed ? "Completed" : "Incomplete"}
                        </span>
                      </div>
                      <div>
                        <span
